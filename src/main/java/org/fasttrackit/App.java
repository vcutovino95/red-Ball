...
import javax.swing.WindowConstants;
 ...
 class RedBall extends JComponent implements ActionListener, MouseMotionListener, KeyListener {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (score >= 5) {
            ...
            g.drawString(String.valueOf(score + score1), 30 - 15, 80);
        } else {
            g.setColor(Color.white);
            g.setFont(new Font("Arial", 8, 50));
            g.drawString(String.valueOf(score), 30 - 15, 80);
        }
        // start && gameOver
        g.setColor(Color.white);
        g.setFont(new Font("Arial", 8, 50));
        ...
        if (gameOver) {
            g.drawString(String.valueOf(" Best Score :" + scorefinal), 50 - 15, 200);
        }
    }
